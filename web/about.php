    ...
    <div class="main-banner inner" id="home">
        ...
        <header class="header">
            <div class="container-fluid px-lg-5">
                ...
                <nav class="py-4">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="fa fa-bold" aria-hidden="true"></span>pompies</a></h1>
                    </div>
    ...
    <section class="hand-crafted py-5">
        <div class="container">
            <div class="inner-sec py-md-5 px-lg-5">
                ...
                <p class="mb-4 text-center px-lg-4">Kami menghargai pelanggan kami lebih dari segalanya, dan kepuasan Anda adalah tujuan kami! Selamat datang untuk Anda! Terima kasih telah mengunjungi kami.</p>
            </div>
        </div>
    </section>
    <!-- //ab -->
        ...
        <div class="container py-md-3">
            <div class="row banner-grids">
                ...
                <div class="col-md-6 last-img pl-lg-5 p-3">
                    ...
                    <p class="mb-4"> Hanya berlaku pembelian hari ini.stok terbatas</p>
                    <ul class="tic-info list-unstyled">
                        <li>

                            <span class="fa fa-check mr-2"></span> Tinggi 5 cm

                        </li>
                        <li>

                            <span class="fa fa-check mr-2"></span> Kulit Asli

                        </li>
                        <li>

                            <span class="fa fa-check mr-2"></span> Sangat Lembut

                        </li>
                        <li>

                            <span class="fa fa-check mr-2"></span> Tidak pudar
    ...
    <section class="testimonials py-5">
        <div class="container">
            <div class="test-info text-center">
                ...
                <p><span class="fa fa-quote-left"></span> Sangat bagus dan tidak mengecewakan <span class="fa fa-quote-right"></span></p>
            ...
            <div class="row footer-top">
                <div class="col-lg-4 footer-grid_section_w3layouts">
                    <h2 class="logo-2 mb-lg-4 mb-3">
                        <a href="index.html"><span class="fa fa-bold" aria-hidden="true"></span></a>
                    </h2>
                ...
                <div class="col-lg-8 footer-right">
                        ...
                        <div class="col-md-4 footer-grid_section_w3layouts my-md-0 my-5">
                            ...
                            <div class="contact-info">
                                ...
                                <div class="footer-address-inf my-4">
                                    ...
                                    <p><a href="mailto:info@example.com">reinaagesti02@gmail.com</a></p>
                                </div>
                                <div class="footer-address-inf">
                                    <h4 class="ad-info mb-2">Location</h4>
                                    <p>Cikupa,Citra Raya</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="cpy-right text-left row">
                        <p class="col-md-10">© 2019 Bpompies. All rights reserved | Design by
                            <a href="http://w3layouts.com"> Reina Agesti.</a>
                        </p>
                        <!-- move top icon -->
